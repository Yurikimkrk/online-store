    ...
    <Container className="d-flex justify-content-center align-items-center"
      ...
      <Card style={{width: 600}} className="p-5">
        ...
        <Form className="d-flex flex-column">
          <Form.Control placeholder="Введите e-mail" className="mt-4" value={email}
                        onChange={e => setEmail(e.target.value)}/>
          <Form.Control placeholder="Введите пароль" className="mt-3" value={password}
          ...
          <div className="d-flex justify-content-around mt-3">
            ...
            <Button variant={'outline-success'} style={{width: 150}}
                    className="align-self-end" onClick={click}>
